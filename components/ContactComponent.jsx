...
const ContactComponent = () => {
  return (
    <div
      ...
      <article className='z-10 py-[30px] px-[60px] bg-selected/10 rounded-xl border-selected/40 border-2 self-center shadow-[0_0_30px_10px_rgba(0,0,0,0.5)]'>
        <p className='font-main text-xl text-center mb-[60px]'>
          If you want to chat or start working with me, you can find me at:
          <br />
          <br />
          DEMANDA DE SOFI: Cambiar colores para resaltar
        </p>
