...
const WorkComponent = () => {
  return (
    <div
      id='work'
      className='snap-center w-full h-fit flex flex-shrink-0 flex-col justify-center items-start px-[10%] gap-[60px]'>
      <div className='w-full '>
        ...
        <div className='w-full flex flex-wrap gap-[2rem] justify-around'>
        <XPcard />
        <XPcard />
        <XPcard />
        <XPcard />
